...
const AddUser: React.FC = () => {
    ...
    const onFileSelectionChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const saveUser = () => {
        ...
        UserService.create(organisationId, teamId, formData)
            .then((response: any) => {
                setUser({
                    id: response.data.id,
                                ...
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600">
                                        ...
                                        >
                                            ...
                                            <input id="image" name="image" type="file" className="sr-only" onChange={onFileSelectionChange} />
                                        </label>
